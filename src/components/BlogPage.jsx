...
const BlogPage = () => {
    ...
    return (
        <div>
            ...
            <div className='p-20 my-auto min-h-screen' ref={ref}>
                <p className='text-2xl font-semibold'> 1. Differences between uncontrolled and controlled components.</p>
                <p className='mb-10 mt-3'>Definition: Controlled components are managed by their parent component, while uncontrolled components manage their own state internally. <br></br>
                ...
                <p className='text-2xl font-semibold'> 2. How to validate React props using PropTypes?</p>
                ...
                <p className='text-2xl font-semibold'> 3. Difference between nodejs and express js?</p>
                <p  className='mb-10 mt-3'>
                ...
                <p className='text-2xl font-semibold'>4. What is a custom hook, and why will you create a custom hook?</p>
                <p className='mb-10 mt-3'>
